"""
Engine phương pháp Tìm kiếm hủy-dựng thích nghi cá nhân hóa (PADCS) - Bộ giải TOPTW
...
class PADCS:
    ...
    def _print_gen_status(
        ...
        print(
            f"[PADCS] Gen {gen:>3}/{self.generations} | "
    ...
    def _initialize_population(self) -> list[Individual]:
        ...
        print("[PADCS] Population initialized and evaluated.")
    ...
    def run(self) -> OptimizationResponse:
        """
        Chạy vòng lặp tiến hóa chính của PADCS.
